...
//     version 1.13.0
//     from Assets/Movimentacao.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Movimentacao.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @Movimentacao: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ""maps"": [
        {
            ""name"": ""Jogador"",
            ""id"": ""b3331e94-4a57-4d10-9261-5142eda20824"",
            ""actions"": [
                {
                    ""name"": ""Mover"",
                    ""type"": ""Value"",
                    ""id"": ""f40695e2-522b-4830-8530-04164abd6222"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""a7ec15dd-11c5-45bb-9dfa-f3e3a272de9b"",
    ...
    ~@Movimentacao()
    {
        UnityEngine.Debug.Assert(!m_Jogador.enabled, "This will cause a leak and performance issues, Movimentacao.Jogador.Disable() has not been called.");
    }
    ...
    {
        private @Movimentacao m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public JogadorActions(@Movimentacao wrapper) { m_Wrapper = wrapper; }
        /// <summary>
